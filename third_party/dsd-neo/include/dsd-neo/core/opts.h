...
struct dsd_opts {
    ...
    /* When 1, interpret received TSBKs as ISP (inbound from mobile) rather than
     * OSP (outbound from site). Used by site simulators listening on the site
     * input channel (where mobiles transmit). */
    int p25_isp_mode;
